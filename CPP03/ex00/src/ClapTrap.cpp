...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (this->Hit_points == 0)
    {
        std::cout << YELLOW_COLOR << "ClapTrap " << this->Name << " is already dead!" << RESET_COLOR << std::endl;
        return;
    }
    std::cout << YELLOW_COLOR << "ClapTrap " << this->Name << " takes " << amount << " points of damage!" << RESET_COLOR << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout << YELLOW_COLOR << "ClapTrap " << this->Name << " is already at full health!" << RESET_COLOR << std::endl;
        return;
    }
    std::cout << YELLOW_COLOR << "ClapTrap " << this->Name << " is being repaired for " << amount << " points!" << RESET_COLOR << std::endl;
    this->Energy_points -= 1;
    if(amount + this->Hit_points > 10)
    {
        this->Hit_points = 10;
        std::cout << YELLOW_COLOR << "ClapTrap " << this->Name << " is at full health!" << RESET_COLOR << std::endl;
        return;
    }
    this->Hit_points += amount;
}
